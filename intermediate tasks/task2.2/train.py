...
from myDatasets import EYEPACS_train
...
testset = EYEPACS_train(train = False, get_segmentations = False, get_unlabelled = False, train_ratio = 0.75, equi_sampling = False, transform = test_transform)
testloader = torch.utils.data.DataLoader(testset, batch_size=TRAIN_BATCH_SIZE, num_workers = 2)
trainset = EYEPACS_train(train = True, get_segmentations = False, get_unlabelled = False, train_ratio = 0.75, equi_sampling = True, transform = train_transform)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=TRAIN_BATCH_SIZE, num_workers = 2, shuffle = True)
traintestset = EYEPACS_train(train = True, get_segmentations = False, get_unlabelled = False, train_ratio = 0.75, equi_sampling = False, transform = test_transform)
