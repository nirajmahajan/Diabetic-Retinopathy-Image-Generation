...
class EYEPACS_train(Dataset):
    ...
    def __init__(self, train = None, get_segmentations = False, get_unlabelled = False, train_ratio = 0.75, equi_sampling = False, transform = None, drop_grades = None):
        ...
        if not os.path.exists('/content/train64'):
        	os.system('cp -r /content/drive/Shareddrives/RND_2021_niraj_shalabh/datasets/EYEPACS/train64 /content')
        	os.system('cp -r /content/drive/Shareddrives/RND_2021_niraj_shalabh/datasets/EYEPACS/trainLabels.csv /content')
        self.image_names = []
        self.image_grade = []
        self.get_unlabelled = get_unlabelled
        self.get_segmentations = get_segmentations
